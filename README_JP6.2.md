...
```
sudo cp -r ./images/6.2/rootfs/lib/modules/5.15.*-tegra /lib/modules/
sudo cp -r ./images/6.2/rootfs/boot/dtb ./images/6.2/rootfs/boot/vmlinu?-*-tegra /boot/dev/
```
...
sudo cp -r ./lib/modules/5.15.*-tegra /lib/modules/
